                ...
                <div className="container mx-auto px-4 py-6">
                    ...
                    <section className='flex flex-col lg:flex-row gap-3'>
                        <div className="w-full lg:w-[50%]">
                            ...
                            <div className="mb-6">
                                <h2 className="text-3xl font-semibold text-[#4b7dab] mb-4" dangerouslySetInnerHTML={{ __html: resume.Education.heading || 'Education' }}></h2>
                        ...
                        <div className='w-full lg:w-[50%]'>
                            <h2 className="text-3xl font-semibold text-[#4b7dab] mb-4" dangerouslySetInnerHTML={{ __html: resume.Experience.heading || 'Experience' }}></h2>
