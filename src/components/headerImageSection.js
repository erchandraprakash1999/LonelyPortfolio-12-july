 ...
 export default function HeaderImageSection() {
  return (
    ...
    <p className='text-5xl font-bold '>{headerSection.title}</p>
       ...
       <div className='hover:text-pink-500 mt-2 relative top-0 hover:top-2 transition-[top] '><Link  to="about" smooth duration={100}><FaAngleDoubleDown  fontSize={70} /></Link></div> 
    </section>
    </div>
  )
}
